...
export class SqliteStorage implements Storage {
  ...
  async salasDeUsuario(usuarioId: string): Promise<SalaDeUsuario[]> {
    ...
    return rows.map((r) => ({
      ...
      // El nombre sale del JOIN que ya estaba ahí. Sin él, la lista de quien
      // entra con cuenta pisaba la del navegador (que sí los tenía) y todas las
      // salas volvían a verse por su id.
